...
const MAPPINGS = {
  ...
  androidVersion: {
    // Providing Android SDK/API Version Now, Earlier it was Android Version.
    path: [],
    fun: (data) => {
      const paths = [
        ['ds:5', 1, 2, 140, 1, 1, 0, 0, 0],
        ['ds:5', 1, 2, 112, 141, 1, 1, 0, 0, 0],
        ['ds:5', 1, 2, 103, 141, 1, 1, 0, 0, 0],
        ['ds:5', 1, 2, 96, 141, 1, 1, 0, 0, 0],
        ['ds:5', 1, 2, 80, 141, 1, 1, 0, 0, 0]
      ]
      const value = helper.extractValueFromMultiplePaths(paths, data);
      return value != null ? String(value) : 'VARY';
    }
  },
  androidVersionText: {
    path: [],
    fun: (data) => {
      const paths = [
        ...
        ['ds:5', 1, 2, 112, 141, 1, 1, 0, 0, 1],
        ['ds:5', 1, 2, 103, 141, 1, 1, 0, 0, 1],
        ['ds:5', 1, 2, 96, 141, 1, 1, 0, 0, 1],
        ['ds:5', 1, 2, 80, 141, 1, 1, 0, 0, 1]
      ]
      const value = helper.extractValueFromMultiplePaths(paths, data);
      return value != null ? String(value) : 'Varies with device';
    }
  },
  androidMaxVersion: {
    // Providing Android SDK/API Version Now, Earlier it was Android Version.
    ...
    fun: (data) => {
      const paths = [
        ['ds:5', 1, 2, 140, 1, 0, 0, 0],
        ['ds:5', 1, 2, 112, 141, 1, 0, 0, 0],
        ['ds:5', 1, 2, 103, 141, 1, 0, 0, 0],
        ['ds:5', 1, 2, 96, 141, 1, 0, 0, 0],
        ['ds:5', 1, 2, 80, 141, 1, 0, 0, 0]
      ]
      const value = helper.extractValueFromMultiplePaths(paths, data);
      return value != null ? String(value) : 'VARY';
    }
  ...
  updated: {
    ...
    fun: (data) => {
      const paths = [
        ['ds:5', 1, 2, 145, 0, 1, 0],
        ['ds:5', 1, 2, 112, 146, 0, 1, 0],
        ['ds:5', 1, 2, 103, 146, 0, 1, 0],
        ['ds:5', 1, 2, 96, 146, 0, 1, 0],
        ['ds:5', 1, 2, 80, 146, 0, 1, 0],
      ]
      const value = helper.extractValueFromMultiplePaths(paths, data);
  ...
  version: {
    ...
    fun: (data) => {
      const paths = [
        ['ds:5', 1, 2, 140, 0, 0, 0],
        ['ds:5', 1, 2, 112, 141, 0, 0, 0],
        ['ds:5', 1, 2, 103, 141, 0, 0, 0],
        ['ds:5', 1, 2, 96, 141, 0, 0, 0],
        ['ds:5', 1, 2, 80, 141, 0, 0, 0]
      ]
      const value = helper.extractValueFromMultiplePaths(paths, data);
      return value ? value : 'VARY';
    }
  },
  recentChanges: {
    path: [],
    fun: (data) => {
      const paths = [
        ['ds:5', 1, 2, 144, 1, 1],
        ['ds:5', 1, 2, 112, 145, 1, 1],
        ['ds:5', 1, 2, 103, 145, 1, 1],
        ['ds:5', 1, 2, 96, 145, 1, 1],
        ['ds:5', 1, 2, 80, 145, 1, 1]
      ]
      const value = helper.extractValueFromMultiplePaths(paths, data);
